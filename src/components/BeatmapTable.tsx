        ...
        <td colSpan={6} className="p-0">
          <div className={`relative rounded-md overflow-hidden shadow-lg hover:shadow-xl transition-shadow text-white ${bm.bg_url ? '' : 'bg-[#2e2f34]'}`}>
            ...
            <div className="relative z-20 flex w-full">
              <div className="px-3 py-4 w-1/2 [text-shadow:0_3px_8px_rgba(0,0,0,1)] truncate">{titleDisplay}</div>
              <div className="px-3 py-4 w-1/6 [text-shadow:0_3px_8px_rgba(0,0,0,1)] truncate">{bm.mapper}</div>
              <div className="px-3 py-4 w-1/10 [text-shadow:0_3px_8px_rgba(0,0,0,1)] truncate text-center">{bm.length}</div>
              <div className="px-3 py-4 w-1/10 [text-shadow:0_3px_8px_rgba(0,0,0,1)] truncate text-center">{bm.mode}</div>
